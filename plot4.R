...
plot(dataEpc$datetime, dataEpc$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
plot(dataEpc$datetime, dataEpc$Voltage, type = "l")
...
plot(dataEpc$datetime, dataEpc$Global_active_power, type = "l")
dev.off()
